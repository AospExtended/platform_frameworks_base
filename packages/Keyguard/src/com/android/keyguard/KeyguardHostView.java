    ...
    private final KeyguardUpdateMonitorCallback mUpdateCallback =
       ...
       @Override
        public void onTrustChanged(int userId) {
            ...
            if (mKeyguardUpdateMonitor.getUserCanSkipBouncer(userId) && mKeyguardUpdateMonitor.getUserHasTrust(userId)){if (mKeyguardUpdateMonitor.getUserCanSkipBouncer(userId)
