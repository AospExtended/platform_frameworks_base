...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
                ...
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                ...
                                currChargingVoltage, currBatteryTemp));
                mHandler.sendMessage(msg);
    ...
    public static class BatteryStatus {
        ...
        public BatteryStatus(int status, int level, int plugged, int health, int maxChargingCurrent, int maxChargingVoltage, int maxChargingWattage, double currChargingVolt, double currBatteryTemp) {
            this.status = status;
            this.level = level;
