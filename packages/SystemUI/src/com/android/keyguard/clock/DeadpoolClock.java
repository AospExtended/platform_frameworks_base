 ...
 */
public class DeadpoolClock implements ClockPlugin {
    ...
    private ImageClock mDeadpoolClock;
   ...
   // private TextClock mLockClock;
     ...
     */
    public DeadpoolClock(Resources res, LayoutInflater inflater,
            SysuiColorExtractor colorExtractor) {
        this(res, inflater, colorExtractor, null);
    }

    /**
     * Create a DeadpoolClock instance.
     *
     * @param res Resources contains title and thumbnail.
     * @param inflater Inflater used to inflate custom clock views.
     * @param colorExtractor Extracts accent color from wallpaper.
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater.inflate(R.layout.deadpool_clock, null);
        mDeadpoolClock = mView.findViewById(R.id.deadpool_clock);
    }
    ...
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.deadpool_thumbnail);
    }
    ...
    private void updateColor() {
        ...
        mDeadpoolClock.setClockColors(primary, secondary);
    }

    @Override
    public void onTimeTick() {
        mDeadpoolClock.onTimeChanged();
        mView.onTimeChanged();
    }
    ...
    public void onTimeZoneChanged(TimeZone timeZone) {
        mDeadpoolClock.onTimeZoneChanged(timeZone);
    }
