...
public class CustomTextClock extends TextView {
    ...
    private String getIntStringHour (int hour) {
        return getResources().getStringArray(R.array.TextClockHours)[hour];
    }

    private String getIntStringMin (int minute) {
        return getResources().getStringArray(R.array.TextClockMinutes)[minute];
    }

    private String getHeaderString (int hour) {
        if(hour < 2)
            return getResources().getString(R.string.TextClockHeaderSingular);
        else
            return getResources().getString(R.string.TextClockHeaderPlural);
    }
}
