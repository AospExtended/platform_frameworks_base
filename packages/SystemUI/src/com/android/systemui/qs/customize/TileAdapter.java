...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileStateListener {
    ...
    private class CustomQsSpanSizeLookup extends SpanSizeLookup {
    ...
    private final CustomQsSpanSizeLookup mSizeLookup = new CustomQsSpanSizeLookup();
