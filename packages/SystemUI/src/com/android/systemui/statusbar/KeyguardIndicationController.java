    ...
    private String computeBatteryDetailIndication() {
        ...
        if (showbatteryInfo) {
            ...
            if (!showInvertedCurrent) {
                ...
                powerString.append(String.format("%.1f", (float) (mChargingVolt / 1000000) * (mChargingAmpere / 1000000 * -1)));
            }
            ...
            if (!showInvertedCurrent) {
                ...
                powerString.append(String.format("%.3f", mChargingAmpere / 1000000 * -1));
            }
