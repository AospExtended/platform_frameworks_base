    ...
    private String computeBatteryDetailIndication() {
        ...
        if (showbatteryInfo) {
            ...
            if (!showInvertedCurrent) {
                powerString.append(String.format("%.1f", (float) (mChargingVolt / 1000000) * (mChargingAmpere < 5 ?
                          (mChargingAmpere * 0.000001) : (mChargingAmpere < 4000 ?
                          mChargingAmpere : (mChargingAmpere / 0.000001)))));
            } else {
                powerString.append(String.format("%.1f", (float) (mChargingVolt / 1000000) * (mChargingAmpere < 5 ?
                          (mChargingAmpere * 0.000001) : (mChargingAmpere < 4000 ?
                          mChargingAmpere : (mChargingAmpere / 0.000001))) * -1));
            }
            powerString.append(" W");
            powerString.append(SPACER);
            ...
            powerString.append(SPACER);
            if (!showInvertedCurrent) {
                powerString.append(String.format("%.3f", (mChargingAmpere < 5 ?
                          (mChargingAmpere * 0.000001) : (mChargingAmpere < 4000 ?
                          mChargingAmpere : (mChargingAmpere / 0.000001)))));
            } else {
                powerString.append(String.format("%.3f", (mChargingAmpere < 5 ?
