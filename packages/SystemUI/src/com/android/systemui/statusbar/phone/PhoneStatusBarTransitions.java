...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mNetworkTraffic, mAexLogo, mWeatherTextView, mWeatherImageView;
    ...
    public void init() {
        ...
        mAexLogo = mView.findViewById(R.id.aex_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mAexLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
