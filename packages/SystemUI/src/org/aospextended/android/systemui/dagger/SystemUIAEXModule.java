...
import org.aospextended.android.systemui.assist.AssistManagerGoogle;
...
public abstract class SystemUIAEXModule {
    ...
    @Provides
    @SysUISingleton
    static AEXServices provideAEXServices(Context context, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazyB) {
        return new AEXServices(context, uiEventLogger, lazyB);
    }
