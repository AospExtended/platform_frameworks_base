...
public class KeyguardSliceProviderAEX extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(KeyguardSliceProviderAEX KeyguardSliceProviderAEX, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(KeyguardSliceProviderAEX);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = KeyguardSliceProviderAEX.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                KeyguardSliceProviderAEX = this.mProviderReference.get();
            }
