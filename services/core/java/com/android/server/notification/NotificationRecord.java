...
public final class NotificationRecord {
    ...
    private Light calculateLights() {
        ...
        int channelLightColor = userSetLightColor != 0xFFFFFFFF ? userSetLightColor
                : defaultLightColor;
        ...
        if (mPreChannelsNotification
            ...
            if ((notification.flags & Notification.FLAG_SHOW_LIGHTS) != 0) {
                light = new Light(userSetLightColor != 0xFFFFFFFF ? userSetLightColor : notification.ledARGB,
                ...
                if ((notification.defaults & Notification.DEFAULT_LIGHTS) != 0) {
                    light = new Light(userSetLightColor != 0xFFFFFFFF ? userSetLightColor : defaultLightColor,
